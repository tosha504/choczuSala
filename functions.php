...
if (! function_exists('aw_get_social_icon_svg')) {
	function aw_get_social_icon_svg(string $platform): string
	{
		switch ($platform) {
			case 'facebook':
				return '<svg aria-hidden="true" focusable="false" viewBox="0 0 24 24"><path fill="white" d="M13.5 22v-8h2.7l.4-3.1h-3.1V8.9c0-.9.3-1.5 1.6-1.5h1.7V4.6c-.3 0-1.3-.1-2.5-.1-2.5 0-4.2 1.5-4.2 4.3v2.1H7.3V14h2.8v8h3.4z"/></svg>';

			case 'instagram':
				return '<svg aria-hidden="true" focusable="false" viewBox="0 0 24 24"><path fill="white" d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4c0 3.2-2.6 5.8-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8C2 4.6 4.6 2 7.8 2zm0 2C5.7 4 4 5.7 4 7.8v8.4C4 18.3 5.7 20 7.8 20h8.4c2.1 0 3.8-1.7 3.8-3.8V7.8C20 5.7 18.3 4 16.2 4H7.8zm8.9 2.3a1.1 1.1 0 1 1 0 2.2 1.1 1.1 0 0 1 0-2.2zM12 7a5 5 0 1 1 0 10 5 5 0 0 1 0-10zm0 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6z"/></svg>';

			case 'tiktok':
				return '<svg aria-hidden="true" focusable="false" viewBox="0 0 24 24"><path fill="white" d="M16.6 3c.3 2.4 1.7 3.9 4 4.1v3.1c-1.4.1-2.7-.3-4-1.1v5.8c0 4.8-5.2 7.5-9 4.8-3.3-2.4-3.2-7.6.3-9.7 1-.6 2.1-.9 3.5-.8v3.3c-.4-.1-.8-.1-1.2 0-2 .4-2.8 2.9-1.3 4.2 1.4 1.3 4 .3 4-1.8V3h3.7z"/></svg>';

			case 'youtube':
				return '<svg aria-hidden="true" focusable="false" viewBox="0 0 24 24"><path fill="white" d="M21.6 7.2s-.2-1.5-.8-2.1c-.8-.8-1.7-.8-2.1-.9C15.8 4 12 4 12 4s-3.8 0-6.7.2c-.4.1-1.3.1-2.1.9-.6.6-.8 2.1-.8 2.1S2.2 9 2.2 10.8v1.7c0 1.8.2 3.6.2 3.6s.2 1.5.8 2.1c.8.8 1.9.8 2.4.9 1.7.2 6.4.2 6.4.2s3.8 0 6.7-.2c.4-.1 1.3-.1 2.1-.9.6-.6.8-2.1.8-2.1s.2-1.8.2-3.6v-1.7c0-1.8-.2-3.6-.2-3.6zM10.2 14.9V8.6l5.8 3.2-5.8 3.1z"/></svg>';

			case 'telegram':
				return '<svg aria-hidden="true" focusable="false" viewBox="0 0 24 24"><path fill="white" d="M21.8 4.6 18.5 20c-.2 1.1-.9 1.4-1.8.9l-5-3.7-2.4 2.3c-.3.3-.5.5-1 .5l.4-5.1 9.3-8.4c.4-.4-.1-.6-.6-.3L5.9 13.4.9 11.8c-1.1-.3-1.1-1.1.2-1.6L20.6 2.7c.9-.3 1.7.2 1.2 1.9z"/></svg>';

			case 'whatsapp':
				return '<svg aria-hidden="true" focusable="false" viewBox="0 0 24 24"><path fill="white" d="M12 2a9.8 9.8 0 0 0-8.5 14.8L2.3 22l5.3-1.4A9.8 9.8 0 1 0 12 2zm0 2a7.8 7.8 0 0 1 6.6 12 7.8 7.8 0 0 1-9.2 2.8l-.4-.2-3.2.8.9-3.1-.2-.5A7.8 7.8 0 0 1 12 4zm-3.2 4.1c-.2 0-.5.1-.7.4-.3.3-.9.9-.9 2.2s.9 2.6 1 2.8c.1.2 1.8 2.9 4.5 4 .6.3 1.1.4 1.5.5.6.2 1.2.1 1.6.1.5-.1 1.5-.6 1.7-1.2.2-.6.2-1.1.1-1.2-.1-.1-.2-.2-.5-.3l-1.7-.8c-.3-.1-.5-.1-.7.2l-.8 1c-.1.2-.3.2-.6.1-.3-.1-1.2-.4-2.2-1.4-.8-.8-1.4-1.8-1.5-2.1-.2-.3 0-.4.1-.5l.4-.5c.1-.2.2-.3.3-.5.1-.2.1-.4 0-.5L9.6 8.6c-.2-.4-.4-.5-.8-.5z"/></svg>';

			case 'linkedin':
				return '<svg aria-hidden="true" focusable="false" viewBox="0 0 24 24"><path fill="white" d="M6.9 21H3.5V9h3.4v12zM5.2 7.4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM21 21h-3.4v-5.8c0-1.4 0-3.2-2-3.2s-2.3 1.5-2.3 3.1V21H10V9h3.2v1.6h.1c.4-.8 1.5-1.9 3.2-1.9 3.4 0 4.1 2.3 4.1 5.2V21H21z"/></svg>';

			case 'x':
				return '<svg aria-hidden="true" focusable="false" viewBox="0 0 24 24"><path fill="white" d="M18.2 2.5h3.1l-6.8 7.8 8 11.2h-6.3l-4.9-6.4-5.6 6.4H2.6l7.3-8.3L2.2 2.5h6.4l4.4 5.9 5.2-5.9zm-1.1 17h1.7L7.7 4.4H5.9l11.2 15.1z"/></svg>';

			case 'custom':
			default:
				return '<svg aria-hidden="true" focusable="false" viewBox="0 0 24 24"><path fill="white" d="M10.6 13.4a1 1 0 0 1 0-1.4l2.8-2.8a3 3 0 1 1 4.2 4.2l-2 2a1 1 0 0 0 1.4 1.4l2-2a5 5 0 1 0-7.1-7.1L9.2 10.6a1 1 0 0 0 1.4 1.4zm2.8-2.8a1 1 0 0 1 0 1.4l-2.8 2.8a3 3 0 1 1-4.2-4.2l2-2A1 1 0 0 0 7 7.2l-2 2a5 5 0 1 0 7.1 7.1l2.8-2.8a1 1 0 0 0-1.5-1.4z"/></svg>';
		}
	}
}
